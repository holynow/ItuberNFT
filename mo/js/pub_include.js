...
var include = {
    ...
    fixBottom : function(){
        ...
        document.write('<button type="button" class="bton_gotop">');
    ...
    footer : function(){
        ...
        document.write('서울시 마포구 토정로 194 (두리번)');
        document.write('</address>');
        document.write('<ul class="addr_list">');
        document.write('<li>');
        ...
        document.write('<li>');
        document.write('<a href="#none">');
        document.write('<i class="ico_facebook"></i>');
        document.write('<span class="a11y">페이스북 바로가기</span>');
        document.write('</a>');
        document.write('</li>');
        document.write('<li>');
        document.write('<a href="#none">');
        document.write('<i class="ico_instagram"></i>');
        document.write('<span class="a11y">인스타그램 바로가기</span>');
        document.write('</a>');
        document.write('</li>');
        document.write('<li>');
        document.write('<a href="#none">');
        document.write('<i class="ico_yotube"></i>');
